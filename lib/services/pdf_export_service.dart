...
class PdfExportService {
  /// Exportiert eine Sammlung inkl. Qualifier und Notizen.
  static Future<void> exportCollection({
    required CodeCollection collection,
    required String? Function(String) titleOf,
    ...
    pdf.addPage(
      pw.MultiPage(
        ...
        header: (context) => pw.Column(
          ...
          children: [
            pw.Text(collection.name,
                style: pw.TextStyle(
                    fontSize: 18, fontWeight: pw.FontWeight.bold)),
            pw.SizedBox(height: 4),
            pw.Text(
              'ICF Klassifikation - Erstellt am ${now.day}.${now.month}.${now.year}',
        ...
        build: (context) => collection.entries.map((entry) {
          final detail = details[entry.code];
          final title = titleOf(entry.code) ?? '';
          return pw.Container(
                ...
                pw.Row(
                  children: [
                    pw.Container(
                      ...
                      child: pw.Text(entry.qualifiedCode,
                          style: pw.TextStyle(
