/// Complete ICF (International Classification of Functioning, Disability and Health)
/// Code System - German titles (Deutsche Fassung, BfArM 2005)
///
/// Source: WHO ICF, German translation by DIMDI/BfArM
/// Structure: Domain prefix (b/s/d/e) + Chapter (1 digit) + Category (2-4 digits)
///
/// Each entry: 'code': 'German title'

class IcfClassification {
  /// The four top-level ICF domains
  ...
  /// All ICF codes with German titles, organized hierarchically.
  /// The map is flat for easy lookup; hierarchy is encoded in the code structure:
  ///   - 2 chars (e.g. "b1") = chapter
  ///   - 3-4 chars (e.g. "b110") = second-level category
  ///   - 4-5 chars (e.g. "b1100") = third-level category
  ///   - 5-6 chars (e.g. "b11420") = fourth-level category
  static const Map<String, String> codes = {
    ...
    'b1264': 'Offenheit gegenüber neün Erfahrungen',
    'b1265': 'Optimismus',
    'b1266': 'Selbstvertraün',
    ...
    'b1300': 'Ausmass der psychischen Energie',
    'b1301': 'Motivation',
    'b1302': 'Appetit',
    ...
    'b1520': 'Angemessenheit der Emotion',
    ...
    'b21000': 'Binokulare Sehschärfe in der Ferne',
    'b21001': 'Monokulare Sehschärfe in der Ferne',
    'b21002': 'Sehschärfe im Nahbereich bei binokularem Sehen',
    'b21003': 'Sehschärfe im Nahbereich bei monokularem Sehen',
    'b21008': 'Die Sehschärfe betreffende Funktionen, anders bezeichnet',
    'b21009': 'Die Sehschärfe betreffende Funktionen, nicht näher bezeichnet',
    ...
    'b2158': 'Funktionen von Strukturen in Verbindung mit dem Auge, anders bezeichnet',
    'b2159': 'Funktionen von Strukturen in Verbindung mit dem Auge, nicht näher bezeichnet',
    ...
    'b2403': 'Übelkeit in Verbindung mit Schwindelgefühl oder Schwindel',
    ...
    'b28014': 'Schmerz in den oberen Gliedmassen',
    'b28015': 'Schmerz in den unteren Gliedmassen',
    ...
    'b2808': 'Schmerz, anders bezeichnet',
    'b2809': 'Schmerz, nicht näher bezeichnet',
    ...
    'b340': 'Alternative stimmliche Äusserungen',
    'b3400': 'Erzeugung von Tönen',
    'b3401': 'Erzeugung einer Variation von stimmlichen Äusserungen',
    'b3408': 'Alternative stimmliche Äusserungen, anders bezeichnet',
    'b3409': 'Alternative stimmliche Äusserungen, nicht näher bezeichnet',

    'b398': 'Stimm- und Sprechfunktionen, anders bezeichnet',
    'b399': 'Stimm- und Sprechfunktionen, nicht näher bezeichnet',

    // --- Kapitel b4: Funktionen des kardiovaskulaeren, haematologischen, Immun- und Atmungssystems ---
    ...
    'b415': 'Blutgefässfunktionen',
    'b4150': 'Funktionen der Arterien',
    'b4151': 'Funktionen der Kapillaren',
    'b4152': 'Funktionen der Venen',
    'b4158': 'Funktionen der Blutgefässe, anders bezeichnet',
    'b4159': 'Funktionen der Blutgefässe, nicht näher bezeichnet',
    ...
    // Funktionen des haematologischen und des Immunsystems (b430-b439)
    'b430': 'Funktionen des hämatologischen Systems',
    'b4300': 'Hämatopöse',
    'b4301': 'Saürstofftransportfunktion des Blutes',
    ...
    'b4352': 'Funktionen der Lymphgefässe',
    ...
    // Weitere Funktionen und Empfindungen (b450-b469)
    'b450': 'Weitere Atmungsfunktionen',
    'b455': 'Funktionen der kardiorespiratorischen Belastbarkeit',
    'b4550': 'Allgemeine Ausdaürleistung',
    'b4551': 'Ärobe Kapazität',
    'b4552': 'Ermüdbarkeit',
    ...
    // --- Kapitel b5: Funktionen des Verdauungs-, des Stoffwechsel- und des endokrinen Systems ---
    'b5': 'Funktionen des Verdauungs-, des Stoffwechsel- und des endokrinen Systems',

    // Funktionen des Verdauungssystems (b510-b539)
    ...
    // Funktionen des Stoffwechsel- und endokrinen Systems (b540-b559)
    'b540': 'Allgemeine Stoffwechselfunktionen',
    'b5400': 'Grundumsatz',
    'b5401': 'Kohlenhydratstoffwechsel',
    'b5402': 'Eiweissstoffwechsel',
    ...
    'b5508': 'Funktionen der Wärmeregulation, anders bezeichnet',
    'b5509': 'Funktionen der Wärmeregulation, nicht näher bezeichnet',

    'b555': 'Funktionen der endokrinen Drüsen',
    'b559': 'Funktionen im Zusammenhang mit dem Stoffwechsel- und endokrinen System, anders oder nicht näher bezeichnet',

    'b598': 'Funktionen des Verdauungs-, des Stoffwechsel- und des endokrinen Systems, anders bezeichnet',
    'b599': 'Funktionen des Verdauungs-, des Stoffwechsel- und des endokrinen Systems, nicht näher bezeichnet',

    // --- Kapitel b6: Funktionen des Urogenital- und reproduktiven Systems ---
    'b6': 'Funktionen des Urogenital- und reproduktiven Systems',

    // Harnbildung und -ausscheidung (b610-b639)
    ...
    'b640': 'Sexülle Funktionen',
    'b6400': 'Funktionen der sexüllen Erregungsphase',
    'b6401': 'Funktionen der Vorspielphase',
    'b6402': 'Funktionen der Orgasmusphase',
    'b6403': 'Funktionen der sexüllen Entspannungsphase',
    'b6408': 'Sexülle Funktionen, anders bezeichnet',
    'b6409': 'Sexülle Funktionen, nicht näher bezeichnet',

    'b650': 'Menstruationsfunktionen',
    'b6500': 'Regelmässigkeit des Menstruationszyklus',
    ...
    'b698': 'Funktionen des Urogenital- und reproduktiven Systems, anders bezeichnet',
    'b699': 'Funktionen des Urogenital- und reproduktiven Systems, nicht näher bezeichnet',

    // --- Kapitel b7: Neuromuskuloskeletale und bewegungsbezogene Funktionen ---
    ...
    'b7203': 'Beweglichkeit der Fusswurzel',
    ...
    'b740': 'Funktionen der Muskelausdaür',
    'b7400': 'Ausdaür einzelner Muskeln',
    'b7401': 'Ausdaür von Muskelgruppen',
    'b7402': 'Ausdaür aller Muskeln des Körpers',
    'b7408': 'Funktionen der Muskelausdaür, anders bezeichnet',
    'b7409': 'Funktionen der Muskelausdaür, nicht näher bezeichnet',

    'b749': 'Funktionen der Muskeln, anders oder nicht näher bezeichnet',

    // Bewegungsfunktionen (b750-b789)
    ...
    'b7653': 'Stereotypien und motorische Perseverationen',
    ...
    // --- Kapitel b8: Funktionen der Haut und der Hautanhangsgebilde ---
    ...
    'b898': 'Funktionen der Haut und der Hautanhangsgebilde, anders bezeichnet',
    'b899': 'Funktionen der Haut und der Hautanhangsgebilde, nicht näher bezeichnet',

    // =========================================================================
    // s - KOERPERSTRUKTUREN (Body Structures)
    // =========================================================================

    // --- Kapitel s1: Strukturen des Nervensystems ---
    's1': 'Strukturen des Nervensystems',

    's110': 'Struktur des Gehirns',
    's1100': 'Struktur der Grosshirnhälften',
    ...
    's11008': 'Struktur des Grosshirns, anders bezeichnet',
    's11009': 'Struktur des Grosshirns, nicht näher bezeichnet',
    ...
    // --- Kapitel s2: Das Auge, das Ohr und mit diesen in Zusammenhang stehende Strukturen ---
    ...
    's298': 'Strukturen des Auges, des Ohres und mit diesen in Zusammenhang stehende Strukturen, anders bezeichnet',
    's299': 'Strukturen des Auges, des Ohres und mit diesen in Zusammenhang stehende Strukturen, nicht näher bezeichnet',

    // --- Kapitel s3: Strukturen, die an der Stimme und dem Sprechen beteiligt sind ---
    ...
    's398': 'An Stimme und Sprechen beteiligte Strukturen, anders bezeichnet',
    's399': 'An Stimme und Sprechen beteiligte Strukturen, nicht näher bezeichnet',

    // --- Kapitel s4: Strukturen des kardiovaskulaeren, des Immun- und des Atmungssystems ---
    ...
    // --- Kapitel s5: Mit dem Verdauungs-, Stoffwechsel- und endokrinen System in Zusammenhang stehende Strukturen ---
    ...
    's598': 'Strukturen des Verdauungs-, Stoffwechsel- und endokrinen Systems, anders bezeichnet',
    's599': 'Strukturen des Verdauungs-, Stoffwechsel- und endokrinen Systems, nicht näher bezeichnet',

    // --- Kapitel s6: Mit dem Urogenital- und dem Reproduktionssystem in Zusammenhang stehende Strukturen ---
    ...
    's698': 'Strukturen des Urogenital- und Reproduktionssystems, anders bezeichnet',
    's699': 'Strukturen des Urogenital- und Reproduktionssystems, nicht näher bezeichnet',

    // --- Kapitel s7: Mit der Bewegung in Zusammenhang stehende Strukturen ---
    ...
    's7502': 'Struktur der Knöchelregion und des Fusses',
    's75020': 'Knochen der Knöchelregion und des Fusses',
    's75021': 'Sprunggelenk und Gelenke des Fusses und der Zehen',
    's75022': 'Muskeln der Knöchelregion und des Fusses',
    's75023': 'Bänder und Faszien der Knöchelregion und des Fusses',
    's75028': 'Struktur der Knöchelregion und des Fusses, anders bezeichnet',
    's75029': 'Struktur der Knöchelregion und des Fusses, nicht näher bezeichnet',
    ...
    's798': 'Mit der Bewegung in Zusammenhang stehende Strukturen, anders bezeichnet',
    's799': 'Mit der Bewegung in Zusammenhang stehende Strukturen, nicht näher bezeichnet',

    // --- Kapitel s8: Strukturen der Haut und Hautanhangsgebilde ---
    ...
    's898': 'Strukturen der Haut und Hautanhangsgebilde, anders bezeichnet',
    's899': 'Strukturen der Haut und Hautanhangsgebilde, nicht näher bezeichnet',

    // =========================================================================
    // d - AKTIVITAETEN UND PARTIZIPATION (Activities and Participation)
    // =========================================================================

    // --- Kapitel d1: Lernen und Wissensanwendung ---
    ...
    'd198': 'Lernen und Wissensanwendung, anders bezeichnet',
    'd199': 'Lernen und Wissensanwendung, nicht näher bezeichnet',

    // --- Kapitel d2: Allgemeine Aufgaben und Anforderungen ---
    ...
    'd2201': 'Mehrfachaufgaben abschliessen',
    ...
    'd2302': 'Die tägliche Routine abschliessen',
    ...
    'd4601': 'Sich in anderen Gebäuden ausserhalb der eigenen Wohnung umherbewegen',
    'd4602': 'Sich ausserhalb der eigenen Wohnung und anderen Gebäuden umherbewegen',
    ...
    // Haushaltsgegenstšnde pflegen und anderen helfen (d650-d669)
    ...
    'd6505': 'Innen- und Aussenpflanzen pflegen',
    ...
    'd6601': 'Anderen bei der Fortbewegung helfen',
    ...
    // --- Kapitel d7: Interpersonelle Interaktionen und Beziehungen ---
    ...
    'd7203': 'Sozialen Regeln gemäss interagieren',
    ...
    // --- Kapitel d8: Bedeutende Lebensbereiche ---
    ...
    'd898': 'Bedeutende Lebensbereiche, anders bezeichnet',
    'd899': 'Bedeutende Lebensbereiche, nicht näher bezeichnet',

    // --- Kapitel d9: Gemeinschafts-, soziales und staatsbuergerliches Leben ---
    ...
    // --- Kapitel e1: Produkte und Technologien ---
    ...
    'e120': 'Produkte und Technologien zur persönlichen Mobilität drinnen und draussen',
    'e1200': 'Allgemeine Produkte und Technologien zur persönlichen Mobilität und zum Transport drinnen und draussen',
    'e1201': 'Hilfsprodukte und unterstützende Technologien zur persönlichen Mobilität drinnen und draussen und zum Transport',
    'e1208': 'Produkte und Technologien zur persönlichen Mobilität drinnen und draussen und zum Transport, anders bezeichnet',
    'e1209': 'Produkte und Technologien zur persönlichen Mobilität drinnen und draussen und zum Transport, nicht näher bezeichnet',
    ...
    'e1358': 'Produkte und Technologien für die Erwerbstätigkeit, anders bezeichnet',
    'e1359': 'Produkte und Technologien für die Erwerbstätigkeit, nicht näher bezeichnet',
    ...
    'e150': 'Entwurf, Konstruktion sowie Bauprodukte von öffentlichen Gebäuden',
    ...
    'e1502': 'Entwurf, Konstruktion sowie Bauprodukte und Technologien zur Wegefindung in öffentlichen Gebäuden',
    ...
    'e155': 'Entwurf, Konstruktion sowie Bauprodukte von privaten Gebäuden',
    ...
    'e1552': 'Entwurf, Konstruktion sowie Bauprodukte und Technologien zur Wegefindung in privaten Gebäuden',
    ...
    // --- Kapitel e2: Natuerliche und vom Menschen veraenderte Umwelt ---
    ...
    'e2500': 'Laut-/Geräuchintensität oder -stärke',
    'e2501': 'Laut-/Geräuchqualität',
    'e2508': 'Laute und Geräuche, anders bezeichnet',
    'e2509': 'Laute und Geräuche, nicht näher bezeichnet',
    'e255': 'Schwingung',
    'e260': 'Luftqualität',
    'e2600': 'Luftqualität in Innenbereichen',
    'e2601': 'Luftqualität in Aussenbereichen',
    ...
    // --- Kapitel e4: Einstellungen ---
    'e4': 'Einstellungen',

    'e410': 'Individülle Einstellungen des engsten Familienkreises',
    'e415': 'Individülle Einstellungen des erweiterten Familienkreises',
    'e420': 'Individülle Einstellungen von Freunden',
    'e425': 'Individülle Einstellungen von Bekannten, Kollegen und Nachbarn',
    'e430': 'Individülle Einstellungen von Autoritätspersonen',
    'e435': 'Individülle Einstellungen von Untergebenen',
    'e440': 'Individülle Einstellungen von Hilfs- und Pflegepersonen',
    'e445': 'Individülle Einstellungen von Fremden',
    'e450': 'Individülle Einstellungen von Gesundheitsfachleuten',
    'e455': 'Individülle Einstellungen von anderen Fachleuten',
    ...
    // --- Kapitel e5: Dienste, Systeme und Handlungsgrundsaetze ---
    'e5': 'Dienste, Systeme und Handlungsgrundsätze',

    'e510': 'Konsumgüterproduktion',
    ...
    'e545': 'Ziviler Schutz und Sicherheit',
    ...
    'e575': 'Allgemeine soziale Unterstützung',
    ...
    'e585': 'Bildungs- und Ausbildungswesen',
  ...
  /// ICF qualifier scale for body functions and structures
  /// Used to rate the severity of impairment
  static const Map<int, String> qualifierScale = {
    0: 'Problem nicht vorhanden (kein, fehlend, unerheblich) 0-4%',
    1: 'Problem leicht ausgeprägt (gering, niedrig) 5-24%',
    2: 'Problem mässig ausgeprägt (mittel, ziemlich) 25-49%',
    3: 'Problem erheblich ausgeprägt (hoch, extrem) 50-95%',
    4: 'Problem voll ausgeprägt (komplett, total) 96-100%',
    8: 'Nicht spezifiziert',
    9: 'Nicht anwendbar',
  };

  /// Environmental factors can be coded as barriers or facilitators
  static const Map<String, String> environmentalQualifiers = {
    'barrier_0': 'Kein Hindernis',
    'barrier_1': 'Leichtes Hindernis',
    'barrier_2': 'Mässiges Hindernis',
    'barrier_3': 'Erhebliches Hindernis',
    'barrier_4': 'Vollständiges Hindernis',
    'facilitator_0': 'Kein Förderfaktor',
    'facilitator_1': 'Leichter Förderfaktor',
    'facilitator_2': 'Mässiger Förderfaktor',
    'facilitator_3': 'Erheblicher Förderfaktor',
    'facilitator_4': 'Vollständiger Förderfaktor',
  };

  /// Get all chapter codes for a given domain
  static List<String> getChapters(String domain) {
    final chapters = <String>[];
    final prefix = domain.toLowerCase();
  ...
  /// Get all direct children of a given code
  static List<String> getChildren(String parentCode) {
    final children = <String>[];
    final targetLength = parentCode.length + (parentCode.length == 2 ? 1 : 1);
    // For chapters (2 chars like "b1"), children are 3-digit codes like "b110"
    // For 3-digit codes (like "b110"), children are 4-digit codes like "b1100"
    // etc.

    for (final code in codes.keys) {
      if (code.startsWith(parentCode) && code.length == parentCode.length + (parentCode.length <= 2 ? 2 : 1)) {
        // Special case: chapter codes map to 3-char codes (e.g., b1 -> b110, not b11)
        if (parentCode.length == 2 && code.length == 4) {
          children.add(code);
        }
      }
      // For non-chapter parents, direct children are +1 length
      if (parentCode.length > 2 && code.startsWith(parentCode) && code.length == parentCode.length + 1) {
        children.add(code);
      }
    }
    return children;
  ...
  /// Get the title for a given ICF code
  static String? getTitle(String code) => codes[code];

  /// Get the parent code for a given code
  static String? getParentCode(String code) {
    if (code.length <= 2) return null; // Domain level
    if (code.length == 4) {
      // 3-digit category -> parent is chapter (e.g., b110 -> b1)
      return code.substring(0, 2);
    }
    // Otherwise, parent is one character shorter
    return code.substring(0, code.length - 1);
  }

  /// Search codes by title (case-insensitive)
  static Map<String, String> search(String query) {
    final q = query.toLowerCase();
    return Map.fromEntries(
      codes.entries.where((e) => e.value.toLowerCase().contains(q)),
    );
  }

  /// Get all codes for a specific domain
  static Map<String, String> getCodesForDomain(String domainPrefix) {
    return Map.fromEntries(
      codes.entries.where((e) => e.key.startsWith(domainPrefix)),
    );
  }

  /// Build a tree structure from the flat map for UI rendering
  static List<IcfNode> buildTree() {
    final roots = <IcfNode>[];
    for (final domain in domains.entries) {
      final domainNode = IcfNode(
        code: domain.key,
        title: domain.value,
        children: [],
      );
      ...
      for (final entry in codes.entries) {
        if (entry.key.startsWith(domain.key) && entry.key.length == 2) {
          final chapterNode = IcfNode(
            code: entry.key,
            title: entry.value,
            children: [],
          );
          // Add second-level categories
          for (final cat in codes.entries) {
            if (cat.key.startsWith(entry.key) && cat.key.length == 4) {
              final catNode = IcfNode(
                code: cat.key,
                title: cat.value,
                children: [],
              );
              // Add third-level categories
              for (final sub in codes.entries) {
                if (sub.key.startsWith(cat.key) && sub.key.length == 5) {
                  final subNode = IcfNode(
                    code: sub.key,
                    title: sub.value,
                    children: [],
                  );
                  // Add fourth-level categories
                  for (final deep in codes.entries) {
                    if (deep.key.startsWith(sub.key) && deep.key.length == 6) {
                      subNode.children.add(IcfNode(
                        code: deep.key,
                        title: deep.value,
                        children: [],
                      ));
              ...
              chapterNode.children.add(catNode);
            }
          }
          domainNode.children.add(chapterNode);
        }
      }
...
/// Tree node for hierarchical ICF display
class IcfNode {
  final String code;
  final String title;
  ...
  @override
  String toString() => '$code: $title (${children.length} children)';
}
